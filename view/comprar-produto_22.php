...
<!-- </div> -->
	<div class="column2" id="menu_lateral">
		...
		<ul>
			...
			<li><a href="#"><i class="glyphicon glyphicon-paperclip"></i> Vender</a></li>
...
<div class="container2">
		...
		<form method="post" action="index.php?cod=comprar-produto&acao=salvarEntradaProduto">
			<div>
				...
				<input type="text" id="codigobarras" name="codigobarras" class="input" onkeyup="buscarProduto(this.value);" />
